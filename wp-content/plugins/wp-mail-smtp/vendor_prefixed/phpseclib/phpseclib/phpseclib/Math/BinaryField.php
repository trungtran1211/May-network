...
class BinaryField extends \WPMailSMTP\Vendor\phpseclib3\Math\Common\FiniteField
{
    ...
    public function __construct(...$indices)
    {
        ...
        \WPMailSMTP\Vendor\phpseclib3\Math\BinaryField\Integer::setModulo($this->instanceID, $modulo);
        \WPMailSMTP\Vendor\phpseclib3\Math\BinaryField\Integer::setRecurringModuloFunction($this->instanceID, $reduce);
        $this->randomMax = new \WPMailSMTP\Vendor\phpseclib3\Math\BigInteger($modulo, 2);
    }
    /**
    ...
    {
        return new \WPMailSMTP\Vendor\phpseclib3\Math\BinaryField\Integer($this->instanceID, $num instanceof \WPMailSMTP\Vendor\phpseclib3\Math\BigInteger ? $num->toBytes() : $num);
    }
    /**
    ...
    public function randomInteger()
    {
        ...
        return new \WPMailSMTP\Vendor\phpseclib3\Math\BinaryField\Integer($this->instanceID, \WPMailSMTP\Vendor\phpseclib3\Math\BigInteger::randomRange($one, $this->randomMax)->toBytes());
    }
    /**
    ...
    {
        return \strlen(\WPMailSMTP\Vendor\phpseclib3\Math\BinaryField\Integer::getModulo($this->instanceID));
    }
    /**
    ...
    {
        return \strlen(\WPMailSMTP\Vendor\phpseclib3\Math\BinaryField\Integer::getModulo($this->instanceID)) << 3;
    }
    /**
    ...
    {
        $str = \WPMailSMTP\Vendor\phpseclib3\Common\Functions\Strings::bits2bin($x);
        $pad = \strlen($x) >> 3;
        if (\strlen($x) & 3) {
            $pad++;
        }
    ...
    public static function base256ToBase2($x)
    {
        ...
        return \WPMailSMTP\Vendor\phpseclib3\Common\Functions\Strings::bin2bits($x);
    }
}
