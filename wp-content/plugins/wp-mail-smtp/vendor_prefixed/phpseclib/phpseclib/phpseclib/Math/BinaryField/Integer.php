...
class Integer extends \WPMailSMTP\Vendor\phpseclib3\Math\Common\FiniteField\Integer
{
    ...
    private static function polynomialDivide($x, $y)
    {
        ...
        while (($degr = static::deg($r)) >= $d) {
            ...
            $s = \WPMailSMTP\Vendor\phpseclib3\Math\BinaryField::base2ToBase256($s);
    ...
    private static function regularPolynomialMultiply($x, $y)
    {
        ...
        $x = \strrev(\WPMailSMTP\Vendor\phpseclib3\Math\BinaryField::base256ToBase2($x));
        $y = \strrev(\WPMailSMTP\Vendor\phpseclib3\Math\BinaryField::base256ToBase2($y));
        ...
        $result = \WPMailSMTP\Vendor\phpseclib3\Math\BinaryField::base2ToBase256($result);
        $size = \strlen($result);
        $x = \strrev($x);
        // precompute left shift 1 through 7
        for ($i = 1; $i < 8; $i++) {
            $precomputed[$i] = \WPMailSMTP\Vendor\phpseclib3\Math\BinaryField::base2ToBase256($x . \str_repeat('0', $i));
        }
    ...
    public function toBits()
    {
        ...
        return \WPMailSMTP\Vendor\phpseclib3\Math\BinaryField::base256ToBase2($this->value);
    }
    /**
    ...
    {
        return new \WPMailSMTP\Vendor\phpseclib3\Math\BigInteger($this->value, 256);
    }
    /**
