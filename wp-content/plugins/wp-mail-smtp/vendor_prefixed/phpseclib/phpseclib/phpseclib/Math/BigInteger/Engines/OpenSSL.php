...
abstract class OpenSSL
{
     ...
     * @return Engine
     */
    public static function powModHelper(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\Engine $x, \WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\Engine $e, \WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\Engine $n)
    {
        ...
        $key = \WPMailSMTP\Vendor\phpseclib3\Crypt\RSA\Formats\Keys\PKCS8::savePublicKey(new \WPMailSMTP\Vendor\phpseclib3\Math\BigInteger($n), new \WPMailSMTP\Vendor\phpseclib3\Math\BigInteger($e));
