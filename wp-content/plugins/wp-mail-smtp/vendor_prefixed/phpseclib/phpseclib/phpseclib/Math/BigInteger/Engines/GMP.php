...
class GMP extends \WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\Engine
{
     ...
     * @return GMP
     */
    public function add(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\GMP $y)
    {
        $temp = new self();
     ...
     * @return GMP
     */
    public function subtract(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\GMP $y)
    {
        $temp = new self();
        $temp->value = $this->value - $y->value;
        return $this->normalize($temp);
     ...
     * @return GMP
     */
    public function multiply(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\GMP $x)
    {
        $temp = new self();
     ...
     * @return bool
     */
    public function equals(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\GMP $x)
    {
     ...
     * @return false|GMP
     */
    public function modInverse(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\GMP $n)
    {
        $temp = new self();
     ...
     * @return GMP
     */
    public function gcd(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\GMP $n)
    {
     ...
     * @return GMP
     */
    public function bitwise_and(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\GMP $x)
    {
        $temp = new self();
        $temp->value = $this->value & $x->value;
        return $this->normalize($temp);
     ...
     * @return GMP
     */
    public function bitwise_or(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\GMP $x)
    {
        $temp = new self();
        $temp->value = $this->value | $x->value;
        return $this->normalize($temp);
     ...
     * @return GMP
     */
    public function bitwise_xor(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\GMP $x)
    {
        $temp = new self();
        $temp->value = $this->value ^ $x->value;
        return $this->normalize($temp);
     ...
     * @return GMP
     */
    public function modPow(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\GMP $e, \WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\GMP $n)
    {
     ...
     * @return GMP
     */
    public function powMod(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\GMP $e, \WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\GMP $n)
    {
        return $this->powModOuter($e, $n);
    }
    /**
     ...
     * @return GMP
     */
    protected static function randomRangePrimeInner(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\Engine $x, \WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\Engine $min, \WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\Engine $max)
    {
     ...
     * @return false|GMP
     */
    public static function randomRangePrime(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\GMP $min, \WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\GMP $max)
    {
     ...
     * @return GMP
     */
    public static function randomRange(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\GMP $min, \WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\GMP $max)
    {
     ...
     * @return GMP
     */
    public function pow(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\GMP $n)
    {
        $temp = new self();
     ...
     * @return GMP
     */
    public static function min(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\GMP ...$nums)
    {
     ...
     * @return GMP
     */
    public static function max(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\GMP ...$nums)
    {
     ...
     * @return bool
     */
    public function between(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\GMP $min, \WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\GMP $max)
    {
     ...
     * @return int
     */
    public static function scan1divide(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\GMP $r)
    {
