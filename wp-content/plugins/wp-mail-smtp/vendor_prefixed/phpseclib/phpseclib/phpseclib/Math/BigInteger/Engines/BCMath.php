...
class BCMath extends \WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\Engine
{
     ...
     * @return BCMath
     */
    public function add(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath $y)
    {
        $temp = new self();
     ...
     * @return BCMath
     */
    public function subtract(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath $y)
    {
        $temp = new self();
     ...
     * @return BCMath
     */
    public function multiply(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath $x)
    {
        $temp = new self();
     ...
     * @return BCMath
     */
    public function gcd(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath $n)
    {
     ...
     * @return BCMath
     */
    public function bitwise_and(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath $x)
    {
     ...
     * @return BCMath
     */
    public function bitwise_or(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath $x)
    {
     ...
     * @return BCMath
     */
    public function bitwise_xor(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath $x)
    {
        return $this->bitwiseXorHelper($x);
    }
    /**
     ...
     * @see self::equals()
     */
    public function compare(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath $y)
    {
     ...
     * @return bool
     */
    public function equals(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath $x)
    {
     ...
     * @return BCMath
     */
    public function modPow(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath $e, \WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath $n)
    {
     ...
     * @return BCMath
     */
    public function powMod(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath $e, \WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath $n)
    {
        return $this->powModOuter($e, $n);
    }
    /**
     ...
     * @return false|BCMath
     */
    public static function randomRangePrime(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath $min, \WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath $max)
    {
     ...
     * @return BCMath
     */
    public static function randomRange(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath $min, \WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath $max)
    {
     ...
     * @return BCMath
     */
    public function pow(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath $n)
    {
        $temp = new self();
     ...
     * @return BCMath
     */
    public static function min(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath ...$nums)
    {
     ...
     * @return BCMath
     */
    public static function max(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath ...$nums)
    {
     ...
     * @return bool
     */
    public function between(\WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath $min, \WPMailSMTP\Vendor\phpseclib3\Math\BigInteger\Engines\BCMath $max)
    {
