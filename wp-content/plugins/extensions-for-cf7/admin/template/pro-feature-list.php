	...
	<div class="ext-cf7-options-area">
		<table class="form-table extcf7-others-extensions" role="presentation">
			<tbody>
				...
				<tr>
					<th><?php echo esc_html__('Drad and Drop File Upload','cf7-extensions');?></th>
					<td class="extcf7-checkbox">
