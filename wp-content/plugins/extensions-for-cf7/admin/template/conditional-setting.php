<?php
	$condition_mode = get_option('conditional_mode')?get_option('conditional_mode'):'normal';
	$animation_enable = get_option('animation_enable')?get_option('animation_enable'):'on';
	$admimation_in_time = get_option('admimation_in_time')?get_option('admimation_in_time'):'250';
	$admimation_out_time = get_option('admimation_out_time')?get_option('admimation_out_time'):'250';
?>
